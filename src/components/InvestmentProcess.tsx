...
export default function InvestmentProcess() {
  return (
    <section id="private-consultations" className="py-40 bg-industrial-charcoal-dark border-t border-white/5 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 text-center">
        ...
        >
          ...
          <p className="font-sans text-lg md:text-xl text-gray-400 leading-loose font-light max-w-2xl mx-auto">
            Due to the bespoke nature of our heritage projects, a formal consultation is required to assess the engineering requirements and site logistics.
          </p>

          <p className="font-sans text-[10px] tracking-[0.3em] uppercase text-gray-500 mt-16 mb-20">
            Custom installations begin at $25,000
          </p>
