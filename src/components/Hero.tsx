  ...
  return (
    ...
    {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 text-center flex flex-col items-center mt-20 md:mt-32">
        ...
        >
          Original American-Made Farm Windmills
        </motion.p>
        ...
        >
          We sell, install & restore<br className="hidden md:block" />
           <span className="italic font-light text-white/70"> farm windmills.</span>
        </motion.h1>
        ...
        >
          Family owned and operated since 2012, Midwest Windmill Company sells complete pumping farm windmill systems built right in the heart of the Midwest. Pump water for your home, fill ponds, aerate ponds, water orchards, and water livestock — all powered by the wind with quality American steel built to last for decades.
        </motion.p>
